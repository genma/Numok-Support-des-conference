...
\title[Reprenons le contrôle de notre vie privée sur Internet]{Conférence sur la protection de la vie privée \\et des données personnelles\\~\\Reprenons le contrôle de notre vie privée \\sur Internet} 
\author{Genma}
...
\begin{frame}
\begin{center}
\Huge{Une petite vidéo pour commencer?}
\end{center}
\end{frame}

%----------------------------------------------------------------------------------------
\begin{frame}
\justifying{ Les Nouveaux loups du web sort en avant-première le 15 novembre en haut des Champs-Elysées au Publicis Cinémas avec Framasoft/Pierre-Yves Gosset et La Quadrature du Net/ Adrienne Charmet-Alix en intervenants à la fin de la projection.}
\begin{center}
\includegraphics[scale=0.6] {./images/LoupWeb.jpg}
\end{center}
\end{frame}
...
\begin{frame}
 \hspace{-1cm} 
\includegraphics[scale=0.5] {./images/Lightbeam.jpg}
\end{frame}
